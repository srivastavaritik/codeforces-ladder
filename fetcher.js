...
margin-bottom: 1rem;
	...
	display:flex;
	justify-content:space-around;\"><span id="cf_username">${getCookie('cf_username')}</span><br><span><a href="index.html">Home</a></span><br><button onclick=\"changeUser()\"> Change User </button></div>`)
